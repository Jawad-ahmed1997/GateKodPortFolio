          ...
          <div className="col-md-8 col-lg-9">
            <div className="content sm-mb30">
              <Split>
                ...
                <h2 className="wow words chars splitting" data-splitting>about your <br /> <b className="back-color">next project</b>.</h2>
              </Split>
            </div>
          </div>

          <div className="col-md-4 col-lg-3 valign">
            <Link href={`/contact/contact-light`} className="butn bord curve wow fadeInUp" data-wow-delay=".5s">
